$(function() {
    ...
    $(window).on('touchstart mousedown',function(e){
        ...
        $(window).on('touchmove mousemove',function(e){
            var x ,y;
            if(e.originalEvent.touches){
                x = rotate.X - (e.originalEvent.touches[0].clientY - mouseY) / 6;
                y = rotate.Y + (e.originalEvent.touches[0].clientX - mouseX) / 6;
                console.log(e.originalEvent.touches[0].clientX);
                console.log(e.originalEvent.touches[0].clientY);
            }else{
                x = rotate.X - (e.clientY - mouseY) / 6;
                y = rotate.Y + (e.clientX - mouseX) / 6;
            }
    ...
    $(window).on('touchend mouseup',function(){
        ...
        if (Math.abs(juli.X) > 3 || Math.abs(juli.Y) > 3) {
            inertiaTime = setInterval(function() {
